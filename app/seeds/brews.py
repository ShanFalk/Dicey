    ...
    db.session.add_all(
        [
            ...
            Brew(
                ...
                for_sale=True,
                user_id=2,
                brew_tags=[x for x in tags if x.name == "Medieval"]),
            ...
            Brew(
                ...
                for_sale=True,
                user_id=2,
                brew_tags=[x for x in tags if x.name == "Funny"]),
            ...
            Brew(
                ...
                for_sale=True,
                user_id=1,
                brew_tags=[x for x in tags if x.name == "Regency"]),
            ...
            Brew(
                ...
                for_sale=True,
                user_id=1,
                brew_tags=[x for x in tags if x.name == "Science-Fantasy"]),
            ...
            Brew(
                ...
                for_sale=True,
                user_id=2,
                brew_tags=[x for x in tags if x.name == "Noir"]),

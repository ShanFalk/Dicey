...
class CreateReview(FlaskForm):
    ...
    content = StringField("content", validators=[DataRequired(message="You must must write something."), Length(min=1, max=255, message="Your review must be 255 characters or less.")])
